...
import { useAppStore, dispatchAction } from '../store/AppStore';
...
export const MockExamEngine: React.FC<MockExamEngineProps> = ({ initialBinderId, initialQuestionCount, onGradeCompleted }) => {
  ...
  const weaknessQuestions = useAppStore(s => s.weaknessQuestions);
  ...
  useEffect(() => {
    if (weaknessQuestions && weaknessQuestions.length > 0) {
      ...
      setError(null);
      setUserAnswers({});
      dispatchAction('SET_WEAKNESS_QUESTIONS', null);
    }
  }, [weaknessQuestions]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-input border border-border rounded-lg px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-primary font-semibold"
              />
            </div>
          </div>
